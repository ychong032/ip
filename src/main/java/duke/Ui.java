...
public class Ui {
    ...
    /**
     * Prints an error message for when the inputted date for the deadline is in the wrong format.
     */
    ...
    /**
     * Prints all the matching tasks in the task list where the search phrase is found. Prints a different message if
     * no matching tasks are found.
     * @param copyOfTasks a copy of the task list, containing only the matching tasks.
